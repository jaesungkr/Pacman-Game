...
public class Ghost extends Rectangle implements Runnable {
    ...
    // Image img = new Image("ghost1.png");
 ...
 */
    public Ghost(double x, double y, Color color, Maze maze, GameManager gameManager) {
        ...
        if(color == Color.DEEPPINK) {
        	this.setFill(new ImagePattern(new Image("ghost1.png")));	
        }
        else if(color == Color.GREENYELLOW) {
        	this.setFill(new ImagePattern(new Image("ghost2.png")));	
        }
        else if(color == Color.BLACK) {
        	this.setFill(new ImagePattern(new Image("ghost3.png")));	
        }
        else if(color == Color.SPRINGGREEN) {
        	this.setFill(new ImagePattern(new Image("ghost4.png")));
        }
        else {
        	this.setFill(new ImagePattern(new Image("ghost5.png")));
        }
        //this.setFill(color);
        this.timesWalked = 0;
        this.direction = "down";
